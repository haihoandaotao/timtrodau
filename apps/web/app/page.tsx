  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-12 pt-5">
      {user ? (
        ...
        /* Khách: banner slide ảnh tự chạy + CTA đăng ký (không có tìm phòng) */
        <>
          <Carousel />
          <div className="mt-4 flex flex-wrap justify-center gap-3">
            <Link href="/register/student" className="rounded-xl bg-brand px-5 py-2.5 font-semibold text-white transition hover:bg-brand-dark">
              🎓 Đăng ký tân sinh viên
            </Link>
            <Link href="/register/landlord" className="rounded-xl border border-brand px-5 py-2.5 font-semibold text-brand transition hover:bg-brand-50">
              🏠 Đăng ký chủ trọ
            </Link>
          </div>
        </>
